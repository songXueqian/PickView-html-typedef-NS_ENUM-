...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    ...
    self.frame = CGRectMake(toolViewX, toolViewY, toolViewW, 220);
}
-(void)setUpPickView{
    
    UIPickerView *pickView=[[UIPickerView alloc] init];
    
    pickView.backgroundColor=[UIColor colorWithRed:227.f/255.f green:227.f/255.f blue:227.f/255.f alpha:1];
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.backgroundColor=[UIColor colorWithRed:227.f/255.f green:227.f/255.f blue:227.f/255.f alpha:1];
    if (_defaulDate) {
...
//    UIBarButtonItem *centerSpace=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 9.0) {
        if ([UIScreen mainScreen].bounds.size.width == 320) {
            toolbar.items=@[centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace];
        } else if ([UIScreen mainScreen].bounds.size.width == 375) {
            toolbar.items=@[centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace];
        } else {
        ...
        if ([UIScreen mainScreen].bounds.size.width == 320) {
            ...
            toolbar.items=@[centerSpace,centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace,centerSpace];
        }
    }
...
{
    [self remove];
//    [self.delegate isDefault];
}

-(void)show{
    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y+self.frame.size.height, [UIScreen mainScreen].bounds.size.width, self.frame.size.height);
